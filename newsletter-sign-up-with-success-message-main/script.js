...
function enteredEmail() {
    let getEmail = document.getElementById("enteredEmail");
    if (input_desktop.value === input_desktop.value) {
        getEmail.style.fontWeight = "bold";
        getEmail.innerHTML = input_desktop.value;
    }
}
